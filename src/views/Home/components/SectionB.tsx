  ...
  return (
    <div className="justify-between gap-16 px-4 lg:flex mt-9 lg:mt-14 lg:px-0">
      ...
      <div className="text-center mt-9 lg:mt-16 lg:text-left">
        <div className="text-2xl text-center lg:text-right lg:text-3xl">如何确保用户的本金和投资收益的安全？</div>
        <div className="text-[#666666] leading-8 mt-7 lg:mt-14 text-base lg:text-base">
...
const Table = () => (
  <div className="mt-[45px] lg:mt-[90px] text-center">
    <div className="text-2xl leading-8 lg:text-3xl">AUSD 与其他稳定币对比 (流动性是2023年 七月全球成交量)</div>
